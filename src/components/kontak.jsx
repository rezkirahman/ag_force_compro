                        ...
                        <div className="bg-blue-100 p-4 mx-auto rounded-2xl flex items-center justify-between lg:px-16 lg:p-10">
                            <div className="space-y-1 w-2/3 xl:space-y-5">
                                ...
                                <div>
                                    ...
                                    <h3>
                                        Hubungi melalui WhatsApp: <Link href='https://wa.me/+6282129819050' target='_blank'><span className="text-primary cursor-pointer hover:underline">+62 821-2981-9050</span></Link>
                                    </h3>
                                </div>
